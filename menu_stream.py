...
# Define constants for Google Drive API
SCOPES = ['https://www.googleapis.com/auth/drive.readonly']
SERVICE_ACCOUNT_FILE = '/home/suvin/PycharmProjects/pythonProject/Project/Google_Drive/Google_Drive_Final/' \
                       'fetch-url-384806-32bff5946d0d.json'
...
def display_summary_statistics(df):
    ...
    mac_stats = mac_stats.set_index("No")
    # st.write(mac_stats)
    st.dataframe(mac_stats, width=1130)
